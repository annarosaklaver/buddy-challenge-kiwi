...
letters_handsstill_plot <- ggplot(letters_results_handsstill,
  ...
  labs(title = "Bayes factors in favour of null", 
...
To assess the robustness of our findings for the Letter and Location model, we conducted a sensitivity analysis across a range of ROPE widths and prior specifications, based on the sensitivity analysis presented in Roettger & Franke (2025). Across both models, the Bayes factors consistently favour the null hypothesis. These findings remain stable across various priors and ROPE widths.
...
![Figure 1: Letters model / Hands-still condition](output/letters_handsstill_sensitivity.png){#fig-letters-handsstill fig-align="left" width="303"}
